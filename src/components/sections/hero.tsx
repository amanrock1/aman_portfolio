          ...
          {!isLoading && (
            <div className="flex flex-col">
              <div>
                ...
                <BlurIn delay={1}>
                  <Tooltip delayDuration={300}>
                    ...
                    >
                      I&apos;m Aman Kumar, a B.Tech CSE student passionate about building modern websites, interactive UI experiences, and AI-assisted projects. I enjoy turning ideas into clean, useful digital products.
                    </TooltipContent>
                  </Tooltip>
                </BlurIn>
              ...
              <div className="mt-8 flex flex-col gap-3 w-fit">
                <Link
                  href={
                    "https://drive.google.com/file/d/15gbx227BA0y99rI79CTLdO5pyblMURoE/view?usp=sharing"
                  }
                  target="_blank"
                  className="flex-1"
                >
